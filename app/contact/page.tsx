        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="flex flex-col gap-10">
              <div className="relative bg-white text-brand-grey p-10 shadow-2xl rounded-sm aspect-[1.6/1] flex flex-col justify-between overflow-hidden group">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <h3 className="text-3xl font-bold tracking-tight mb-1">대광 건축</h3>
                    <p className="text-[10px] font-medium text-gray-500 tracking-[0.15em]">LIVING ARCHITECTURE & DESIGN</p>
                  </div>
                </div>

                <div className="flex flex-col items-end mt-12">
                   <div className="flex items-baseline gap-3 mb-6">
                     <span className="text-xs font-bold text-gray-500 uppercase tracking-widest border-b border-brand-gold pb-1">Director</span>
                     <span className="text-3xl font-bold">최 유 모</span>
                   </div>
                   
                   <div className="space-y-1.5 text-right font-medium text-sm text-gray-600">
                     <p><span className="text-[10px] text-gray-400 mr-2">MOBILE:</span> 010-5588-8123</p>
                     <p><span className="text-[10px] text-gray-400 mr-2">E-Mail:</span> cym5588@naver.com</p>
                     <div className="h-4"></div>
                     <p><span className="text-[10px] text-gray-400 mr-2">TEL:</span> (054) 954-9683</p>
                     <p>대구시 북구 서변로 83-1 2층</p>
                   </div>
                </div>
              </div>
