    ...
    <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, idx) => (
              <Link 
                ...
                className="group relative bg-[#222] border border-brand-gold/10 p-10 hover:border-brand-gold/50 transition-all duration-300 flex flex-col h-full cursor-pointer"
              >
                ...
                <div className="mt-8 flex items-center text-brand-gold text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <section className="py-20 bg-brand-gold/5 border-t border-brand-gold/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/contact" className="inline-block bg-brand-gold text-brand-grey px-12 py-4 font-bold text-lg hover:bg-brand-gold-light transition-colors">
            무료 견적 상담 신청하기
          </Link>
        </div>
      </section>
